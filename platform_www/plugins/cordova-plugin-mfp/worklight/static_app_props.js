...
var WL = WL ? WL : {};
WL.StaticAppProps = { APP_ID: 'com.rakcorp',
  APP_VERSION: '0.0.1',
  WORKLIGHT_PLATFORM_VERSION: '8.0.0.00-20200531-153252',
  WORKLIGHT_NATIVE_VERSION: '3870910303',
  LANGUAGE_PREFERENCES: 'en',
  API_PROXY_URL: '/adapters/MobileAPIProxy',
  ENVIRONMENT: 'android',
  WORKLIGHT_ROOT_URL: '/apps/services/api/com.rakcorp/android/',
  APP_SERVICES_URL: '/apps/services/',
  APP_DISPLAY_NAME: 'RakBank',
